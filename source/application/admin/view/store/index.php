    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            <div class="widget-head am-cf">
                <div class="widget-title am-cf">系统列表</div>
            </div>
            <div class="widget-body am-fr">
                <div class="tips am-margin-bottom-sm am-u-sm-12">
                    <div class="pre">
                        <p>温馨提示: 超管后台无需密码即可进入对应系统</p>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle">
                                    <div class="tpl-table-black-operation">
                                        <a href="<?= siteUrl('store/enter', ['wxapp_id' => $item['wxapp_id']]) ?>"
                                           class="j-move" data-id="<?= $item['wxapp_id'] ?>" target="_blank">
                                            <i class="am-icon-arrow-right"></i> 进入系统
                                        </a>
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= siteUrl('store/recovery') ?>";
