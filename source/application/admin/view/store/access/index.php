            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    <div class="tips am-margin-bottom-sm am-u-sm-12">
                        <div class="pre">
                            <p> 温馨提示: 此处数据为公众号系统后台的页面url，用于给管理员角色设置操作权限</p>
                        </div>
                    </div>
                    <!-- 工具栏 -->
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= siteUrl('store.access/edit', ['access_id' => $item['access_id']]) ?>">
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= siteUrl('store.access/delete') ?>";
