...
class Plan extends Controller
{
    ...
    public function add()
    {
        ...
        if ($this->model->add($this->postData('plan'))) {
            return $this->renderSuccess('添加成功', siteUrl('market.recharge.plan/index'));
        }
    ...
    public function edit($plan_id)
    {
        ...
        if ($model->edit($this->postData('plan'))) {
            return $this->renderSuccess('更新成功', siteUrl('market.recharge.plan/index'));
        }
    ...
    public function delete($plan_id)
    {
        ...
        // 更新记录
        if ($model->setDelete()) {
            return $this->renderSuccess('删除成功', siteUrl('market.recharge.plan/index'));
        }
