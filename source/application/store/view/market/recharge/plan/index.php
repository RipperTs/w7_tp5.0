                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                <?php if (checkPrivilege('market.recharge.plan/add')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success am-radius"
                                           href="<?= siteUrl('market.recharge.plan/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('market.recharge.plan/edit')): ?>
                                                <a href="<?= siteUrl('market.recharge.plan/edit', ['plan_id' => $item['plan_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('market.recharge.plan/delete')): ?>
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= siteUrl('market.recharge.plan/delete') ?>";
