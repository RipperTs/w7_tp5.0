                            ...
                            <div class="wrapper am-container">
                                <div class="left-style am-u-sm-12 am-u-md-12 am-u-lg-4">
                                    <img class="img__category_style"
                                         src="<?= SITE_URL ?>/assets/store/img/category_tpl/<?= $model['category_style'] ?>.png?v=<?= $version ?>">
                                </div>
...
<script>
    $(function () {
        ...
        $("input[name='category[category_style]']").change(function (e) {
            ...
            $imgCategorystyle.attr('src', '<?= SITE_URL ?>/assets/store/img/category_tpl/' + styleValue + '.png?v=' + version);
        });
