...
<link rel="stylesheet" href="<?= SITE_URL ?>/assets/store/css/diy.css?v=<?= $version ?>">
        ...
        <div class="widget-body">
            ...
            <div id="app" class="work-diy dis-flex flex-x-between">
                ...
                <div class="diy-phone" v-cloak>
                    ...
                    <div id="diy-page" class="phone-top optional" @click.stop="onEditer('page')"
                         ...
                         :style="{background: diyData.page.style.titleBackgroundColor + ' siteUrl(<?= SITE_URL ?>/assets/store/img/diy/phone-top-' + diyData.page.style.titleTextColor + '.png) no-repeat center / contain'}">
                                            ...
                                            <div class="diy-officialAccount">
                                                ...
                                                <div class="item-content am-cf">
                                                    <div class="item-cont-avatar am-fl">
                                                        <img src="<?= SITE_URL ?>/assets/store/img/diy/circular.png" alt="">
                                                    </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-8 am-u-end">
                                        ...
                                        <div class="help-block am-padding-top-xs">
                                            <small>文章数据请到 <a href="<?= siteUrl('content.article/index') ?>" target="_blank">内容管理
                                                    - 文章列表</a>
                                                中管理
                                            </small>
                                        </div>
            ...
            <div class="tips am-margin-top-lg am-margin-bottom-sm">
                <div class="pre">
                    ...
                    <p>2. 如需填写链接地址请参考<a href="<?= siteUrl('wxapp.page/links') ?>" target="_blank">页面链接</a></p>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?= SITE_URL ?>/assets/common/js/vue.min.js?v=<?= $version ?>"></script>
<script src="<?= SITE_URL ?>/assets/common/js/Sortable.min.js?v=<?= $version ?>"></script>
<script src="<?= SITE_URL ?>/assets/common/js/vuedraggable.min.js?v=<?= $version ?>"></script>
<script src="<?= SITE_URL ?>/assets/store/js/select.data.js?v=<?= $version ?>"></script>
<script src="<?= SITE_URL ?>/assets/common/plugins/umeditor/umeditor.config.js?v=<?= $version ?>"></script>
<script src="<?= SITE_URL ?>/assets/common/plugins/umeditor/umeditor.min.js?v=<?= $version ?>"></script>
<script src="<?= SITE_URL ?>/assets/store/js/diy.js?v=<?= $version ?>"></script>
<script>
