                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('wxapp.page/edit')): ?>
                                                <a href="<?= siteUrl('wxapp.page/edit', ['page_id' => $item['page_id']]) ?>">
...
<script>
    $(function () {
        ...
        // 删除元素
        $('.item-delete').delete('page_id', "<?= siteUrl('wxapp.page/delete') ?>");

        // 设为首页
        $('.j-setHome').click(function () {
            var pageId = $(this).attr('data-id');
            layer.confirm('确定要将此页面设置为默认首页吗？', function (index) {
                $.post("<?= siteUrl('wxapp.page/sethome') ?>", {page_id: pageId}, function (result) {
