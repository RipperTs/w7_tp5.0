                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">修改轮播图</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">{{:lang("轮播备注")}} </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="banner[remarks]" value="<?= $model['remarks'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                    ...
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <div class="file-item" style="min-width:200px;">
                                                    <a href="<?= $model['image']['file_path'] ?>" title="点击查看大图" target="_blank">
                                                        <img src="<?= $model['image']['file_path'] ?>" style="width:190px;">
                                                    </a>
                                                    <input type="hidden" name="banner[file_id]" value="<?= $model['file_id'] ?>">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="banner[status]" value="10" data-am-ucheck <?= $model['status'] == 10 ? 'checked' : '' ?>>
                                            显示
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="banner[status]" value="20" data-am-ucheck <?= $model['status'] == 20 ? 'checked' : '' ?>>
                                            隐藏
                                        </label>
                                    </div>
                                </div>
                                <div class="am-form-group" >
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" class="tpl-form-input" name="banner[sort]" value="<?= $model['sort'] ?>" required>
                                        <small>数字越小越靠前</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" class="tpl-form-input" name="banner[h5_links]" value="<?= $model['h5_links'] ?>" required>
                                        <small>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3 am-margin-top-lg">
                                        <button type="submit" class="j-submit am-btn am-btn-secondary">{{:lang("修改")}}
                                        </button>
                                    </div>
                                </div>
